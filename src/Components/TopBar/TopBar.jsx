        ...
        <div className="container-fluid">
          <div className="row align-items-center">
            ...
            <div className="col-md-3 d-flex align-items-center">
              <Button variant="contained" className="header__menu-btn btn rounded-circle p-0 ms-3"
            ...
            <div className="col-md-7 d-flex align-items-center justify-content-end">
              ...
              <div className="dropDown-wrapper position-relative">
                <Button variant="contained" className="header__menu-btn btn rounded-circle p-0 ms-3" onClick={handleOpenNotifications}>
                  <FiBell></FiBell>
                </Button>
                <Menu
                  anchorEl={isOpenNotifications}
                  class="notifications dropdown-list"
                  id="notifications"
